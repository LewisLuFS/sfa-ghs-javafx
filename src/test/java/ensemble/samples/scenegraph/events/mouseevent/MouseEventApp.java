...
public class MouseEventApp extends Application {
	...
	// create a observableArrayList of logged events that will be listed in
	// console
	...
	final Rectangle rectangle = new Rectangle(RECT_WIDTH, RECT_HEIGHT,
			new LinearGradient(0, 0, 0, 1, true, CycleMethod.NO_CYCLE,
					new Stop[] { new Stop(1, Color.rgb(156, 216, 255)), new Stop(0, Color.rgb(156, 216, 255, 0.5)) }));
	...
	public Parent createContent() {
		...
		// create circle with method listed below: paramethers: name of the
		// circle, color of the circle, radius
...
//			showOnConsole("Scrolled, deltaX: " + event.getDeltaX() + ", deltaY: " + event.getDeltaY());
	...
	private Circle createCircle(final String name, final Color color, int radius) {
		...
		final Circle circle = new Circle(radius, new RadialGradient(0, 0, 0.2, 0.3, 1, true, CycleMethod.NO_CYCLE,
	...
	private void showOnConsole(String text) {
		// if there is 8 items in list, delete first log message, shift other
		// logs and add a new one to end position
